...
$GLOBALS['TL_DCA']['tl_content']['palettes'][H4aGameScoreElement::TYPE] = '{type_legend},type,headline;{h4a_legend},team_calendar,h4a_season,h4a_event_id;{template_legend:hide},customTpl;{expert_legend:hide},cssID';
$GLOBALS['TL_DCA']['tl_content']['palettes'][H4aSeasonScoreElement::TYPE] = '{type_legend},type,headline;{h4a_legend},team_calendar,h4a_season,my_team_name;{template_legend:hide}customTpl;{expert_legend:hide},cssID';
$GLOBALS['TL_DCA']['tl_content']['palettes'][H4aTimelineElement::TYPE] = '{type_legend},type,headline;{h4a_legend},team_calendar,h4a_season,h4a_event_id;{template_legend:hide},customTpl;{expert_legend:hide},cssID';
